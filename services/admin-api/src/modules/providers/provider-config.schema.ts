...
export const policySchema = z.object({
  realtimeProviderId: z.string().uuid().nullable().optional(),
  textProviderId: z.string().uuid().nullable().optional(),
  asrProviderId: z.string().uuid().nullable().optional(),
  ttsProviderId: z.string().uuid().nullable().optional(),
});
